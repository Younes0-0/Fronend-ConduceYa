...
const authConfig = defineConfig({
  providers: [
    Google({
      clientId: "76577903134-hduuqd19fvhtinl8fjagt55o17f7hch4.apps.googleusercontent.com",
      clientSecret: "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"
    }),
    GitHub({
      clientId: "Ov23liqphyP2NIRdQbPY",
      clientSecret: "b0c7927915eacdec62f3780ec6807470ae7af77f"
    })
  ]
});
...
function AstroAuth(options = authConfig) {
  const { AUTH_SECRET, AUTH_TRUST_HOST, VERCEL, NODE_ENV } = Object.assign(__vite_import_meta_env__, { AUTH_SECRET: "96d526b64f3f0ad59fdea1ab7c6a7a09", AUTH_TRUST_HOST: "true", NODE: process.env.NODE, NODE_ENV: process.env.NODE_ENV, OS: process.env.OS });
...
async function getSession(req, options = authConfig) {
  options.secret ??= "96d526b64f3f0ad59fdea1ab7c6a7a09";
